...
// reference for GLFW key codes from glfw3.h
// the KeyCodes mabey refer to ASCII code

/********************
Here you can use macro definitions to be compatible with key-mapping 
values for different platforms, enabling interface support for different
platforms at compile time.
*******************/
...
#define HZ_KEY_LEFT_SUPER         343   // In windows is win key
